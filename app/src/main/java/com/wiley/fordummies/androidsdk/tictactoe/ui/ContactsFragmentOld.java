...
public class ContactsFragmentOld extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
	...
	public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		return inflater.inflate(R.layout.fragment_contact_list_old, container, false);
	}
	...
	public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
		...
		mContactsListView = activity.findViewById(R.id.contact_list_view_old);
	}

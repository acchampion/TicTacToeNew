...
public class MapsActivityOld extends AppCompatActivity implements LocationEngineCallback<LocationEngineResult>,
			...
			try {
				...
				mapboxGeocoding.enqueueCall(new Callback<>() {
					...
					public void onResponse(@NonNull Call<GeocodingResponse> call, @NonNull Response<GeocodingResponse> response) {
						...
						if (responseBody != null) {
							...
							if (results != null && results.size() > 0) {
								...
								Toast.makeText(MapsActivityOld.this, "No results found.", Toast.LENGTH_SHORT).show();
							}
						}
						//}
					}
					...
					public void onFailure(@NonNull Call<GeocodingResponse> call, @NonNull Throwable throwable) {
						...
						Toast.makeText(MapsActivityOld.this, "Geocoding error, please try again.",
